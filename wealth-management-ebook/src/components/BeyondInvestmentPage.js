...
import { DollarSign, TrendingUp, Shield, Briefcase, Users, BarChart2, Gift, AlertTriangle, FileText } from 'lucide-react';
...
const BeyondInvestmentPage = () => (
  <div className="max-w-4xl mx-auto p-4 md:p-8">
    ...
    <div className="bg-white rounded-lg shadow-lg p-6 mb-8">
      <h3 className="text-xl font-bold text-center text-blue-800 mb-6">United's Comprehensive Wealth Management Framework</h3>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          ...
          <div className="bg-purple-50 p-4 rounded-lg border-t-4 border-purple-500 shadow-md">
            <div className="flex items-center mb-3">
              ...
              <h5 className="font-bold">Tax Preparation and Filing</h5>
            </div>
            <p className="text-sm">Professional assistance with tax returns and documentation</p>
          </div>
    ...
    <ul className="list-disc pl-8 mb-6 space-y-2">
      ...
      <li><strong>Tax Preparation and Filing:</strong> Assisting with tax documentation and returns to ensure compliance and maximize deductions.</li>
